...
$gift_appointment_additional_services = \App\Models\REWASH\Gift_appointment_additional_service::get();
   
   $data = $request->all();


  $gift_appointment_additional_services = Gift_appointment_additional_service::orderby('id','DESC')
...
->with('gift_appointment_additional_services',$gift_appointment_additional_services)
;
...
//searchfun
 ...
 public function store(Request $request)
    ...
    $gift_appointment_additional_service = new Gift_appointment_additional_service ();

         $gift_appointment_additional_service->branch_id = $request->branch_id;
  $gift_appointment_additional_service->gift_appointment_id = $request->gift_appointment_id;
  $gift_appointment_additional_service->additional_service_id = $request->additional_service_id;
  $gift_appointment_additional_service->additional_service_price = $request->additional_service_price;
  $gift_appointment_additional_service->quantity = $request->quantity;
  $gift_appointment_additional_service->total_price = $request->total_price;


    $save = $gift_appointment_additional_service->save();

if ($save) {
    Session::flash('alert-success-link', true);
    Session::flash('alert-link', route('gift_appointment_additional_services.show', $gift_appointment_additional_service->id));
...
return back();
   ...
   // $this->validate($request, ['id' => 'required|exists:gift_appointment_additional_services,id',]);
    ...
    $gift_appointment_additional_service = Gift_appointment_additional_service::find($id);
    ...
    $previous = Gift_appointment_additional_service::where('id','<',$id)->max('id');
       return view('REWASH.gift_appointment_additional_services.gift_appointment_additional_service_view')
        ->with('gift_appointment_additional_service',$gift_appointment_additional_service)
        ->with('next',$next)
  ...
  $gift_appointment_additional_service->total_price = $request->total_price;
    ...
    $update = $gift_appointment_additional_service->update();
