...
use App\Models\REWASH\Not_paid_order;



class Not_paid_orderController extends Controller
{
...
$not_paid_orders = \App\Models\REWASH\Not_paid_order::get();
   
   $data = $request->all();


  $not_paid_orders = Not_paid_order::orderby('id','DESC')
...
return view('REWASH.not_paid_orders.not_paid_orders')

->with('not_paid_orders',$not_paid_orders)
;

//searchfun


                        return view('REWASH.not_paid_orders.not_paid_orders' , compact('not_paid_orders'));
        ...
        public function create()
    {
          ...
          return view('REWASH.not_paid_orders.not_paid_order_add')
       ;
 }
 ...
 public function store(Request $request)
    ...
    $not_paid_order = new Not_paid_order ();

         $not_paid_order->zone_id = $request->zone_id;
  $not_paid_order->zone_name = $request->zone_name;
  $not_paid_order->user_id = $request->user_id;
  $not_paid_order->user_name = $request->user_name;
  $not_paid_order->user_mobile = $request->user_mobile;
  $not_paid_order->number_of_vehicles = $request->number_of_vehicles;
  $not_paid_order->vehicle_id = $request->vehicle_id;
  $not_paid_order->washing_plan_id = $request->washing_plan_id;
  $not_paid_order->name = $request->name;
  $not_paid_order->washing_plan_validity_date = $request->washing_plan_validity_date;
  $not_paid_order->number_of_washes = $request->number_of_washes;
  $not_paid_order->status_id = $request->status_id;
  $not_paid_order->appointment_date = $request->appointment_date;
  $not_paid_order->slot_id = $request->slot_id;
  $not_paid_order->vehicle_no = $request->vehicle_no;
  $not_paid_order->location = $request->location;
  $not_paid_order->notes = $request->notes;
  $not_paid_order->tax_avlue = $request->tax_avlue;
  $not_paid_order->total_price = $request->total_price;
  $not_paid_order->total_price_befor_payment = $request->total_price_befor_payment;
  $not_paid_order->wallet_amount = $request->wallet_amount;
  $not_paid_order->promo_code_id = $request->promo_code_id;
  $not_paid_order->promo_code_discount_value = $request->promo_code_discount_value;
  $not_paid_order->payment_mode_id = $request->payment_mode_id;
  $not_paid_order->payment_status_id = $request->payment_status_id;
  $not_paid_order->payment_status = $request->payment_status;
  $not_paid_order->payment_time = $request->payment_time;
  $not_paid_order->created_by = Auth::user()->id; 
  $not_paid_order->partner_id = $request->partner_id;
  $not_paid_order->accrued_loyalty_point = $request->accrued_loyalty_point;
  $not_paid_order->transaction_id = $request->transaction_id;
  $not_paid_order->platform_id = $request->platform_id;
  $not_paid_order->report_id = $request->report_id;
  $not_paid_order->payment_id = $request->payment_id;
  $not_paid_order->status = $request->status;
  $not_paid_order->description = $request->description;
  $not_paid_order->amount = $request->amount;
  $not_paid_order->fee = $request->fee;
  $not_paid_order->currency = $request->currency;
  $not_paid_order->refunded = $request->refunded;
  $not_paid_order->refunded_at = $request->refunded_at;
  $not_paid_order->captured = $request->captured;
  $not_paid_order->captured_at = $request->captured_at;
  $not_paid_order->voided_at = $request->voided_at;
  $not_paid_order->payment_created_at = $request->payment_created_at;
  $not_paid_order->source = $request->source;
  $not_paid_order->message = $request->message;
  $not_paid_order->reference_number = $request->reference_number;
  $not_paid_order->batch_number = $request->batch_number;
  $not_paid_order->reconciliation_date = $request->reconciliation_date;
  $not_paid_order->company = $request->company;
  $not_paid_order->card_number = $request->card_number;
  $not_paid_order->first_name = $request->first_name;
  $not_paid_order->last_name = $request->last_name;
  $not_paid_order->mobile = $request->mobile;
  $not_paid_order->stcpay_reference = $request->stcpay_reference;
  $not_paid_order->stcpay_token = $request->stcpay_token;
  $not_paid_order->invoice_id = $request->invoice_id;
  $not_paid_order->order_id = $request->order_id;
  $not_paid_order->plan = $request->plan;
  $not_paid_order->pament_zone_id = $request->pament_zone_id;


    $save = $not_paid_order->save();

if ($save) {
    Session::flash('alert-success-link', true);
    Session::flash('alert-link', route('not_paid_orders.show', $not_paid_order->id));
...
return back();
    ...
    {
   // $this->validate($request, ['id' => 'required|exists:not_paid_orders,id',]);

    $not_paid_order = Not_paid_order::find($id);
    $next = Not_paid_order::where('id','>',$id)->min('id');
    $previous = Not_paid_order::where('id','<',$id)->max('id');
       return view('REWASH.not_paid_orders.not_paid_order_view')
        ->with('not_paid_order',$not_paid_order)
        ->with('next',$next)
