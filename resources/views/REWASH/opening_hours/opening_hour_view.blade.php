...
@section('title', __('Opening_hours | Add new opening_hour') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('opening_hours.index') }}">{{ __('Opening_hours') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $opening_hour->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('opening_hours.update' , $opening_hour->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Opening_hours') }}</h5> <small
