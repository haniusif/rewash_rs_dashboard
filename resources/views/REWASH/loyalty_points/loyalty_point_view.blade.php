...
@section('title', __('Loyalty_points | Add new loyalty_point') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('loyalty_points.index') }}">{{ __('Loyalty_points') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $loyalty_point->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('loyalty_points.update' , $loyalty_point->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Loyalty_points') }}</h5> <small
