...
@section('title', __('Company_vehicles | Add new company_vehicle') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('company_vehicles.index') }}">{{ __('Company_vehicles') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $company_vehicle->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('company_vehicles.update' , $company_vehicle->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Company_vehicles') }}</h5> <small
