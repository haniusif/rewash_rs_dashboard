...
@section('title', __('Worker_notifications | Add new worker_notification') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('worker_notifications.index') }}">{{ __('Worker_notifications') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $worker_notification->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('worker_notifications.update' , $worker_notification->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Worker_notifications') }}</h5> <small
