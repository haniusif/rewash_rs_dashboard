...
@section('content')
 			...
 			<div class="page-header">
							<h1>
							       @lang('messages.not_paid_orders_not_paid_orders')
								<small>
									<i class="ace-icon fa fa-angle-double-left"></i>
								      @lang('messages.not_paid_orders_update')
								</small>
							</h1>
						</div><!-- /.page-header -->
    	...
    	<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">  <a href="/not_paid_orders">     @lang('messages.not_paid_orders_not_paid_orders')  </a>  </h4>
													...
													<span class="widget-toolbar">
														...
														<ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
															<li>
<a href="/not_paid_orders/create" title = "@lang('messages.not_paid_orders_add_new')  "  ><i class="fa fa-plus fa-lg"></i>
@lang('messages.not_paid_orders_add_new')
</a>
															</li>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/not_paid_orders') }}">
                        {!! csrf_field() !!}
 ...
 <div class="form-group">
                            <div class="col-md-6 col-md-offset-2">
                                <button type="submit" class="btn btn-primary pull-left">
                                    <i class="fa fa-btn fa-save"></i>@lang('messages.not_paid_orders_update') 
                                </button>
