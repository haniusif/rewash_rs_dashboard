...
@section('title', __('Scheduled_notifications | Add new scheduled_notification') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('scheduled_notifications.index') }}">{{ __('Scheduled_notifications') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $scheduled_notification->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('scheduled_notifications.update' , $scheduled_notification->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Scheduled_notifications') }}</h5> <small
