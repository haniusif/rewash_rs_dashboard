...
<div class="row">
 <div class="breadcrumb-wrapper col-12">
     ...
     @include('REWASH.cities.search.search')
    <div class="col-12">
    <div class="card">
                    <div class="card-body">
...
<th  >{{ __('cities_id') }}</th>
<th  >{{ __('cities_branch_id') }}</th>
<th  >{{ __('cities_name') }}</th>
<th  >{{ __('cities_en_name') }}</th>
<th  >{{ __('cities_tags') }}</th>
...
<td>{{ $city->id }}</td>
<td>{{ $city->branch_id }}</td>
<td>{{ $city->name }}</td>
<td>{{ $city->en_name }}</td>
<td>{{ $city->tags }}</td>
<td>{{ ($city->is_active == 1) ? __("YES") : __("NO") }}</td>
...
<td>{{ $city->updated_at }}</td>         <td>
 ...
 @endforeach
        ...
        <tfoot>
       <tr><td      colspan="9"  >{{$cities->links("pagination::bootstrap-4")}} </td></tr>
        </tfoot>
</table>
                                    </div>
                                </div>
