...
@section('title', __('Slots | Add new slot') )
...
@section('content')
  <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('slots.index') }}">{{ __('Slots') }}</a>
            </li>
            <li class="breadcrumb-item active"> {{ $slot->id }}
            </li>
        </ol>
    </div>
    @include('_partials.alerts')
    <section>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('slots.update' , $slot->id ) }}"
            ...
            <div class="row mt-3">
                ...
                <div class="card h-100 mb-4">
                  <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="mb-0">{{ __('Slots') }}</h5> <small
