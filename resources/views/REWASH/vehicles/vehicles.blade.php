...
<div class="row">
 <div class="breadcrumb-wrapper col-12">
     ...
     @include('REWASH.vehicles.search.search')
    <div class="col-12">
    <div class="card">
                    <div class="card-body">
...
<th  >{{ __('vehicles_vehicle_company_id') }}</th>
<th  >{{ __('vehicles_vehicle_modal_id') }}</th>
<th  >{{ __('vehicles_vehicle_type_id') }}</th>
<th  >{{ __('vehicles_image') }}</th>
<th  >{{ __('vehicles_is_deleted') }}</th>
...
<td>{{ $vehicle->vehicle_company_id }}</td>
<td>{{ $vehicle->vehicle_modal_id }}</td>
<td>{{ $vehicle->vehicle_type_id }}</td>
<td>
<img src="{{ $vehicle->image }}" higth="100" width="100">
 </td>
<td>{{ $vehicle->is_deleted }}</td>
