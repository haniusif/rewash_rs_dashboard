...
@lang('messages.roles_add_new')
           ...
           <div class="col-12 mb-3">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="position-relative has-icon-left">
                                                                    <input  data-toggle="popover" value="{{ old("default" , $role->default)  }}" data-placement="left"  data-content="{{ __('roles_default_data-content') }}" data-trigger="hover"  data-original-title="{{ __('roles_default_data-original-title') }}"
                                                                     type="number"   class="form-control {{ $errors->has('default') ? 'is-invalid' : '' }}" name="default" placeholder="{{ __('roles_default') }}">
                                                                    <div class="form-control-position">
                                                                        <i class="feather icon-file-minus"></i>
                                                                    </div>
