...
@section('content')
 			...
 			<div class="page-header">
							<h1>
							       @lang('messages.web_appointments_web_appointments')
								<small>
									<i class="ace-icon fa fa-angle-double-left"></i>
								      @lang('messages.web_appointments_update')
								</small>
							</h1>
						</div><!-- /.page-header -->
    	...
    	<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">  <a href="/web_appointments">     @lang('messages.web_appointments_web_appointments')  </a>  </h4>
													...
													<span class="widget-toolbar">
														...
														<ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
															<li>
<a href="/web_appointments/create" title = "@lang('messages.web_appointments_add_new')  "  ><i class="fa fa-plus fa-lg"></i>
@lang('messages.web_appointments_add_new')
</a>
															</li>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/web_appointments') }}">
                        {!! csrf_field() !!}
 ...
 <div class="form-group">
                            <div class="col-md-6 col-md-offset-2">
                                <button type="submit" class="btn btn-primary pull-left">
                                    <i class="fa fa-btn fa-save"></i>@lang('messages.web_appointments_update') 
                                </button>
